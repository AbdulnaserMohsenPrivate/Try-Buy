			...
			<div class="row">
					...
					<ul>
						<li class="p-b-10">
							<a href="#" class="stext-107 cl7 hov-cl1 trans-04">
								{{ __('header.women') }} <i class="fa fa-female"></i>
							</a>
						</li>

						<li class="p-b-10">
							<a href="#" class="stext-107 cl7 hov-cl1 trans-04">
								{{ __('header.men') }} <i class="fa fa-male"></i>
							</a>
						</li>

						<li class="p-b-10">
							<a href="#" class="stext-107 cl7 hov-cl1 trans-04">
								{{ __('header.kids') }} <i class="fa fa-child"></i>
							</a>
						</li>
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<ul>
						<li class="p-b-10">
							<a href="#" class="stext-107 cl7 hov-cl1 trans-04">
								{{ __('footer.eyeglasses') }}  <img src={{asset('images\icons\glasses(2).png')}} >
							</a>
						</li>

						<li class="p-b-10">
							<a href="#" class="stext-107 cl7 hov-cl1 trans-04">
								{{ __('footer.sunglasses') }} <img src={{asset('images\icons\sunglasses(9).png')}} > 
							</a>
						</li>
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<ul>
						<li class="p-b-10">
							<a href="#" class="stext-107 cl7 hov-cl1 trans-04">
								{{ __('header.profile') }} <i class="fa fa-address-card-o"></i>
							</a>
						</li>

						<li class="p-b-10">
							<a href="#" class="stext-107 cl7 hov-cl1 trans-04">
								{{ __('footer.wishlist') }} <i class="fa fa-heart"></i>
							</a>
						</li>

						<li class="p-b-10">
							<a href="#" class="stext-107 cl7 hov-cl1 trans-04">
								{{ __('footer.cart') }} <i class="fa fa-shopping-cart"></i>
							</a>
						</li>

						<li class="p-b-10">
							<a href="#" class="stext-107 cl7 hov-cl1 trans-04">
								{{ __('footer.shipping') }} <i class="fa fa-truck"></i>
							</a>
						</li>
						...
						<li class="p-b-10">
							<a href="#" class="stext-107 cl7 hov-cl1 trans-04">
								{{ __('footer.orders') }} <i class="fa fa-hand-peace-o"></i>
							</a>
						</li>
					</ul>
				</div>
