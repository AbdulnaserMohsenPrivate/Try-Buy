        ...
        $('.wrap-slick1').each(function(){
			...
			if($('html').attr('dir')=='rtl')
			{
					$(slick1).slick(
					{
						...
						nextArrow:'<button class="arrow-slick1 prev-slick1"><i class="zmdi zmdi-caret-left"></i></button>',
						prevArrow:'<button class="arrow-slick1 next-slick1"><i class="zmdi zmdi-caret-right"></i></button>',
						dots: showDot,
