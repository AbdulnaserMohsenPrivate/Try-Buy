...
var JEEFITAPI = function() {
    ...
    function Z(a, b) {
        ...
        this.max = void 0 !==
            b ? b : new V(-Infinity, -Infinity, -Infinity)
    }
    ...
    function p(a, b) {
        ...
        x = 0;
        for (c = b.length; x <
            c; x++) k = b[x], a = k.Zc, 3 === a.length ? (a[0].B(e[k.xa]), a[1].B(e[k.F]), a[2].B(e[k.Aa])) : (a[0] = e[k.xa].clone(), a[1] = e[k.F].clone(), a[2] = e[k.Aa].clone());
        return e
    }
    ...
    function ba(a) {
        ...
        for (y = 0; y < r; ++y) {
            ...
            F = 0 ===
                Fb && 0 === g ? 0 : F * (1 + Fb) * Math.pow(2, 1 + g - Math.pow(2, a - 1));
            x[y] = F
        }
        return x
    }
    ...
    function Ua(a) {
        function b(a) {
            return [480, 576, 640,
                648, 720, 768, 800, 960, 1080, 1152, 1280, 1366, 1920
            ].sort(function(b, c) {
                    ...
                    if (a.currentTime) {
                        ...
                        if (0 === w || 0 === r) e("VIDEO_NULLSIZE");
                            ...
                            try {
                                ...
                                y && (w.Lj = y, w.$h = y.getCapabilities(),
                                    w.we = y.getSettings())
                            } catch (Fb) {}
        ...
        if (e)
            if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
                if (c && c.video) {
                    ...
                    c.video.width && c.video.width.ideal && (e.style.width =
                        c.video.width.ideal + "px");
	...
	//me
	//stop every thing and cannot resume 
	function stopCamera() 
	{
		console.log("aaa");
    ...
    function yb() {
        ...
        function x(d) {
            ia ? Aa.ob = Y : Z ? Aa.ob =
                Ja : P ? (y(), Aa.ob = ya === sa.V ? Aa.Jc : 1) : (Aa.ob = g.hc, y());
            qa.fa();
            ...
            if (ia) fa(), ia = !1, b.flush(), D = window.requestAnimationFrame(x);
                ...
                if (P) {
                    ...
                    Aa.pb > g.cb[1] ? (++Aa.Jc, Aa.pb = (g.cb[0] + g.cb[1]) / 2) : Aa.pb < g.cb[0] && (Aa.Jc = Math.max(Aa.Jc - 1, g.hc), Aa.pb = (g.cb[0] + g.cb[1]) /
                        2);
        ...
        var t = [0, 0, 0],
            ...
            Fa = {
                    ...
                    l(g.T + g.save, function(a) {
                        ...
                        v.zk({
                            ...
                            Sj: function(a) {
                                ...
                                b.viewport(1, 0, 1, 1);
                                O.h(!1, !1);
                                1 !== ++Q % 2 && (h += ra, h > na && (F += I, h = hb, F > B && (F =
                                    la, T += p, T > C && (T = ha))));
                                Bb.J();
                                H.set("s104");
                                H.A("u162", g.kd * db);
                ...
                fk: function(d) {
                    function a() {
                        2 === ++b && (Z = !1, Na.sb = qc, Na.Da = pc, Na.la = ua, Na.za =
                            wa, Na.oa = xa, Fa.Fe(), J.ha(Ka), r(), d && d())
                    }
                    var b = 0;
                ...
                Df: function() {
                    window.CanvasListeners &&
                        (nb.init({
                            ...
                            ya === sa.V && (da.scale += a * g.Gj,
                                da.scale = Math.min(Math.max(da.scale, g.Rf[0]), g.Rf[1]), Fa.Yc())
                        }, !0))
                },
                lj: function() {
                    return L.i({
                        ...
                        onload: function() {
                            ...
                            m.switch_viewer3D = function(d, a) {
                                ...
                                if (ya === sa.ra) return V !== sa.va || d ? V === sa.V && d ? (V = sa.va, J.ha(S),
                                    J.ub(1), a && a(), !0) : !1 : (V = sa.V, J.ha(z), J.ub(0), a && a(), !0);
                                var b = 0,
                                    n = 0;
                                if (ya === sa.V) {
                                    ya = sa.Ab;
                ...
                Pf: function(d, a) {
                    ...
                    m.Me = function(d) {
                        d &&
                            (d.preOffset && (Na.Da = d.preOffset), d.preScale && (Na.sb = d.preScale), d.rx && (Na.Mc = d.rx), d.beginBendZ && (Na.za = d.beginBendZ), d.bendStrength && (Na.oa = d.bendStrength), d.maskBranchStartEnd && (Na.la = d.maskBranchStartEnd), m.ready && Fa.Fe())
                    };
    ...
    t.prototype = {
        ...
        lk: function() {
            function a(a, b, c) {
                0 > c && (c += 1);
                1 < c && --c;
                return c < 1 / 6 ? a + 6 * (b - a) * c : .5 > c ? b : c < 2 / 3 ?
                    a + 6 * (b - a) * (2 / 3 - c) : a
            }
    ...
    q.prototype = {
        ...
        Og: function(a, b) {
            ...
            if (.001 > Math.abs(y)) return this.C =
                .5 * (k + this.C), this.m = .5 * (c + this.m), this.o = .5 * (e + this.o), this.s = .5 * (x + this.s), this;
            f = Math.sin((1 - b) * a) / y;
            b = Math.sin(b * a) / y;
            this.C = k * f + this.C * b;
            this.m = c * f + this.m * b;
    ...
    var f = function() {
            ...
            function c(c) {
                L.N() && (c.c = c.c.replace(/gl_FragData\[([0-3])\]/g,
                    "gbuf$1"));
            ...
            function r(a) {
                ...
                "none" !== a.precision &&
                    (a.c = "precision " + a.precision + " float;\n" + a.c);
                a.c = a.Hd + a.c;
            ...
            function k() {
                var a =
                    "u25 u75 u76 u77 u78 u79 u6".split(" ").concat(T, h);
                A.s35 = {
                    name: "_",
            ...
            var y = !1,
                ...
                N = {
                    ...
                    Ja: function() {
                        b.vertexAttribPointer(B.attributes.a0,
                            3, b.FLOAT, !1, 24, 0)
                    },
                    Eg: function() {
                    ...
                    pk: function() {
                        b.vertexAttribPointer(B.attributes.a0, 3, b.FLOAT, !1, 32, 0);
                        b.vertexAttribPointer(B.attributes.a2, 3, b.FLOAT, !1, 32, 12);
                        b.vertexAttribPointer(B.attributes.a1,
                            2, b.FLOAT, !1, 32, 24)
                    },
                    qk: function() {
                        b.vertexAttribPointer(B.attributes.a0, 3, b.FLOAT, !1, 32, 0);
        ...
        J = function() {
            ...
            var y = [],
                ...
                Ka = {
                    ...
                    Wa: function(d) {
                        L.W() ?
                            (f.g("s31NNGLcolor", d), f.g("s31NNGLtexture", d), f.g("s31NNGLtextureNormalMap", d), f.g("s31NNGLtextureParamsMap", d), f.g("s31NNGLtextureNormalParamsMap", d)) : (f.g("s35", d), f.g("s36", d), f.g("s37", d), f.g("s38", d), f.g("s39", d), f.g("s40", d), f.g("s41", d))
                    },
                    Qi: function() {
                        return n
                    },
                    ...
                    ub: function(d) {
                        ...
                        0 >= d ? (aa = 0, 0 !== S && (S = 0, Ma.dk(), v && ka.La.toggle(!0), K && f.g("s20", [{
                            ...
                            S && (S = 1, Ma.Qg(!0)), a()) : (aa = d, 2 !== S && (Ma.Qg(!1), S = 2, a()));
                        f.g("s22", [{
                            type: "1f",
                            name: "u51",
                            value: 1 - d
                    ...
                    oe: function(a) {
                        ...
                        L.W() ? (D = [{
                            ...
                            b.concat(n)), f.g("s31NNGLtexture", [].concat(D, b, n)), f.g("s31NNGLtextureNormalMap", [].concat(D, aa, b, n)), f.g("s31NNGLtextureParamsMap", [{
                            type: "1i",
                            name: "u2",
                            value: 2
                    ...
                    Cg: function(d, a, b, n) {
                        d && (ma = d, pa && ka.ja.vb(d),
                            Ta && ka.ma.vb(d), Bb && ka.Db.vb(d), Y.forEach(function(a) {
                                a.vb(d)
                            }));
                        a && Ka.sk(a, n ? !0 : !1);
                        b && (tb = b);
                    ...
                    animate: function(d) {
                        ...
                        }, 16)) : (l && FPSCounter.Km(), Ka.qg(d), ++T, H || ha && window.requestAnimationFrame(Ka.animate))) : setTimeout(Ka.animate,
                            100)
                    },
                    El: function(d) {
                        X.push(d)
                    ...
                    qg: function(d) {
                        if ((!u.Ca || H && R) && D) {
                            ...
                            Ra.Mh();
                            I.J();
                            u.Zj ? (b.enable(b.BLEND), b.clearColor(0,
                                0, 0, 0), b.clear(b.COLOR_BUFFER_BIT), b.blendFunc(b.ONE, b.ONE_MINUS_SRC_ALPHA)) : b.disable(b.BLEND);
                            H || Oa.Dd();
                            F.position.b(0);
                            F.Ta.b(1);
                            F.Na.b(2);
                            ...
                            p.j();
                            ra.b(0);
                            ia ? (f.set("s8"), la.b(1), ma.b(2), O.h(!1, !1), f.set("s1"), la.J(), p.b(0), O.h(!1, !1)) :
                                (f.set("s7"), O.h(!1, !1), p.b(0));
                            qa.X();
                    ...
                    ra: function() {
                        C || !B || A || u.cf || (C = A = !0, m && clearTimeout(m), ja && clearTimeout(ja), Oa.Kd().rg(),
                ...
                C = {
                    i: function(a) {
                        ...
                        try {
                            ...
                            la ? (Q = b.getExtension("WEBGL_draw_buffers")) &&
                                !u.bf && (h = !0) : h = 4 <= b.getParameter(b.MAX_DRAW_BUFFERS)
                        } catch (N) {
                            return C.Nb(N)
                        }
        ...
        Ma = function() {
            ...
            function f(b) {
                ...
                if (2 === y) {
                    ...
                    a(-(m - k) * u.Vj);
                    m = k
                } else k = e ? b.touches[0].clientX : b.clientX,
                    b = e ? b.touches[0].clientY : b.clientY, ha = 2 * (k - l) * Math.PI / L.H(), B = 2 * (b - p) * Math.PI / L.S(), 4 === y ? (U[0] += ha * u.hg, U[1] -= B * u.hg, U[0] = Math.min(Math.max(U[0], -u.jg), u.jg), U[1] = Math.min(Math.max(U[1], -u.kg), u.kg), R.Cb()) : c(), l = k, p = b
            }
            ...
            function k(a) {
                if (2 !== y && -1 !== y) {
                    ...
                    a.preventDefault();
                    b && 2 === a.touches.length ? (y = 2, m = K(a.touches[0].pageX,
                        a.touches[0].pageY, a.touches[1].pageX, a.touches[1].pageY)) : (y = b || 2 !== a.button ? 1 : 4, l = b ? a.touches[0].clientX : a.clientX, p = b ? a.touches[0].clientY : a.clientY);
                    return !1
                }
            }
                ...
                a: function(b) {
                    function e(a) {
                        ...
                        if (za) {
                            ...
                            la = Array(I.length);
                            for (k = 0; k < I.length; ++k) C = f[k][0][1], la[k] =
                                new Y(a.uvs[0][2 * C], a.uvs[0][2 * C + 1])
                        }
                        var D = fa(U);
                        ...
                        for (k = 0; k < I.length; ++k) f[c * k] = I[k].x, f[c * k + 1] = I[k].y, f[c * k + 2] = I[k].z, f[c * k + 3] = ra[k].x, f[c * k + 4] = ra[k].y, f[c * k + 5] = ra[k].z, za && (f[c * k + 6] = la[k].x,
                            f[c * k + 7] = la[k].y);
                        G.sort(function(a, d) {
                            return a.mb - d.mb
                        });
                    ...
                    function g(a, b) {
                        v[b] && (f.set(v[b].Xi()), B.bind(!1), za ? (f.Ea(), f.Eg()) : (f.Ja(), f.Fg()), v[b].Vb() && (f.ac(), A.Lb(!1), f.Oc(), Oa.fb()),
                            v[b].pi(), v[b].sc(), B.Ba(a.n, a.offset))
                    }
                    ...
                    function T(a, b) {
                        v[b] && (f.set(v[b].Vi()),
                            v[b].Vb() && (A.Lb(!1), f.Oc(), Oa.fb()), B.bind(!1), v[b].hf(za), B.Ba(a.n, a.offset))
                    }
        ...
        Ob = function() {
            var a, b = !1,
                ...
                y = {
                    ...
                    kk: function(e, k) {
                        if (k || b && c) f[1] =
                            e[0], f[2] = e[1], f[3] = e[2], f[4] = e[3], f[5] = e[4], a.postMessage(f)
                    },
                    tk: function() {
                ...
                m = {
                    ...
                    se: function(e) {
                        ...
                        var r = Math.cos(F.o / 2),
                            ...
                            w = Math.sin(F.s / 2),
                            I = F.order;
                        "XYZ" === I ? (k.m = C * r * x + e * A * w, k.o = e * A * x - C * r * w, k.s = e * r * w + C * A * x, k.C = e * r * x - C * A * w) : "YXZ" === I ? (k.m = C * r * x + e * A * w, k.o = e * A * x - C * r * w, k.s = e * r * w - C *
                            A * x, k.C = e * r * x + C * A * w) : "ZXY" === I ? (k.m = C * r * x - e * A * w, k.o = e * A * x + C * r * w, k.s = e * r * w + C * A * x, k.C = e * r * x - C * A * w) : "ZYX" === I ? (k.m = C * r * x - e * A * w, k.o = e * A * x + C * r * w, k.s = e * r * w - C * A * x, k.C = e * r * x + C * A * w) : "YZX" === I ? (k.m = C * r * x + e * A * w, k.o = e * A * x + C * r * w, k.s = e * r * w - C * A * x, k.C = e * r * x - C * A * w) : "XZY" === I && (k.m = C * r * x - e * A * w, k.o = e * A * x - C * r * w, k.s = e * r * w + C * A * x, k.C = e * r * x + C * A * w);
                        y.y -= T;
                        e = g.elements;
                        w = k.x;
                        var p = k.y,
    ...
    var c = function() {
            ...
            return {
                ...
                a: function(e) {
                    ...
                    "undefined" ===
                    typeof e.metalness && (e.metalness = .5);
                    ...
                    var y = e.normalTexture && L.Yh() ? !0 : !1,
                        w = "number" === typeof e.alpha ? [e.alpha, 0, 0, 0] : [e.alpha[0],
                            e.alpha[1] - e.alpha[0], e.alpha[2], e.alpha[3]
                        ],
                        g = 1,
                        h = 0,
                    ...
                    var C = [e.diffuseColor[0] / 255, e.diffuseColor[1] / 255, e.diffuseColor[2] /
                            255
                        ],
            ...
            var a, c, w, r, x, k, g = u.Eh,
                ...
                ea = {
                    ...
                    O: function() {
                        ...
                        k = x + (1 - A) * (1 - x);
                        G.X(5);
                        if (U && W) G.X(6), C.resize(F,
                            T), f.set("s0"), f.Qc("u0", 6), I.bind(!1, !0), C.j(), I.td(), l.b(6), O.h(!0, !0), l.resize(F, T), l.j(), C.b(6), O.h(!1, !1), f.Qc("u0", 0), U = !1;
                        else {
                            b.enable(b.BLEND);
                            ...
                            for (var Q = !0, u = 0; u < v; ++u) 1 === u && (b.blendFunc(b.SRC_ALPHA, b.ONE), f.A("u60",
                                a)), f.A("u59", e + u / v * (Math.PI / 2)), f.M("u58", (Math.random() - .5) / H, (Math.random() - .5) / B), O.h(Q, Q), Q = !1;
                            b.disable(b.BLEND);
                            f.set("s24");
                            f.M("u24", 1 / F, 1 / T);
                            C.j();
                    ...
                    Xg: function() {
                        t && ma && (pa && (clearTimeout(pa), pa = !1), JESSMP.enable(), t = !1,
                            R = Date.now(), M = A)
                    },
                    G: function() {
                        l.remove();
                    ...
                    if (c) {
                        ...
                        if (w) t.Dg(b);
                            ...
                            for (h = 0; h < a.oc; ++h) {
                                ...
                                W[m + 14] = n;
                                W[m + 15] = D;
                                0 !== h && (m = 2 * h, va = 6 * (h - 1), x[va] = m, x[va + 1] =
                                    m - 1, x[va + 2] = m - 2, x[va + 3] = m, x[va + 4] = m + 1, x[va + 5] = m - 1);
    ...
    var bc = {},
        H = function() {
            ...
            function f(a) {
                ...
                a.id = h++;
                void 0 !== a.jk && a.jk.forEach(function(b,
                    c) {
            ...
            var c = !1,
                ...
                h = {
                    ...
                    i: function(e) {
                        ...
                        c.height =
                            e && void 0 !== e.height ? e.height : 512;
            ...
            var a, c, f = 0,
                ...
                h = {
                    ...
                    a: function(a) {
                        ...
                        b.bufferData(b.ARRAY_BUFFER, a.Ga instanceof Float32Array ?
                            a.Ga : new Float32Array(a.Ga), k);
                        g = c;
                        if (a.da) {
                ...
                a: function(e) {
                    ...
                    var m = {
                        ...
                        remove: function() {
                            ...
                            b.framebufferTexture2D(c, b.COLOR_ATTACHMENT0, b.TEXTURE_2D, null,
                                0);
                ...
                J = {
                    i: function() {
                        if (!M) {
                            ...
                            k = [b.TEXTURE0, b.TEXTURE1, b.TEXTURE2, b.TEXTURE3,
                                b.TEXTURE4, b.TEXTURE5, b.TEXTURE6, b.TEXTURE7
                            ];
                    ...
                    a: function(e) {
                        function r() {
                            ...
                            e.isPot ? (b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_S, e.Cc ? b.MIRRORED_REPEAT :
                                b.REPEAT), b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_T, e.aa ? b.MIRRORED_REPEAT : b.REPEAT)) : (b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_S, b.CLAMP_TO_EDGE), b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_T, b.CLAMP_TO_EDGE));
                            ...
                            e.isLinear ? b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MIN_FILTER, e.isMipmap && !Xa ? b.NEAREST_MIPMAP_LINEAR : b.LINEAR) :
                                b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MIN_FILTER, e.isMipmap && !Xa ? b.NEAREST_MIPMAP_NEAREST : b.NEAREST);
                            S = p[e.v - 1];
                            z = v[e.v - 1];
                            aa = m[w];
                            if (wa.N()) {
                        ...
                        var Ea = {
                            ...
                            qf: function(d) {
                                if (Xa) {
                                    ...
                                    var c, n = E,
                                        e = P;
                                    for (c = 1; c <= d; ++c) n /= 2, e /= 2, H.M("u24", .25 / n, .25 / e), b.viewport(0, 0, n, e), a(db[c - 1]), b.framebufferTexture2D(qa.hb(), b.COLOR_ATTACHMENT0,
                                        b.TEXTURE_2D, db[c], 0), O.h(!1, 1 === c);
                                    y[0] = -1
                                } else Ea.tc()
                            },
                            jd: function(a) {
                            ...
                            Wk: function() {
                                b.framebufferTexture2D(qa.hb(), b.COLOR_ATTACHMENT0, b.TEXTURE_2D,
                                    null, 0)
                            },
                            resize: function(a, d) {
                                E = a;
                            ...
                            Mm: function(d) {
                                ...
                                a(I);
                                va && b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, va);
                                c ? (M || (F = document.createElement("canvas"), F.width = E, F.height = P, Q = F.getContext("2d"), T = Q.createImageData(E, P), M = !0), T.data.set(d), Q.putImageData(T, 0, 0), b.texImage2D(b.TEXTURE_2D, 0, z, S, aa, F)) : b.texImage2D(b.TEXTURE_2D,
                                    0, z, E, P, 0, S, aa, d);
                                y[x] = la;
                                va && b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, !1)
                            },
                            ...
                            $b: function(a, c) {
                                ...
                                na || ("RGBA" === a || "RGBE" === a || "RGBAARRAY" === a ? (d = new Uint8Array(D), na = !0) : "JSON" !== a ||
                                    c || Ea.$e());
                                qa.X();
                                H.set(z);
                                Ea.b(0);
                                if ("RGBA" === a || "RGBE" === a || "RGBAARRAY" === a) {
                                    ...
                                    if (c) aa = new Float32Array(n), b.viewport(0, 0, E, P), O.h(!0, !0), b.readPixels(0, 0, E, P, b.RGBA, b.FLOAT, aa);
                                        ...
                                        for (aa =
                                            0; 4 > aa; ++aa) b.viewport(0, P * aa, E, P), H.qa("u125", B[aa]), O.h(!aa, !aa);
                                        Ea.pg();
                                        aa = Array(n);
                        ...
                        if (e.url) a(I), b.texImage2D(b.TEXTURE_2D, 0, b.RGBA, 1, 1, 0, b.RGBA, b.UNSIGNED_BYTE, null), W = new Image, W.Ml = "Anonymous", W.crossOrigin = "Anonymous", W.src = e.url, W.onload = function() {
                            ...
                            ia()
                        } else e.array ? (e.I && !e.isFloat ? e.array instanceof Uint16Array ? (q = e.array, r()) : f() ? (q = c(e.array), r()) : (r(), J.Gi(Ea, e.array, va)) : (q = e.isFloat ? e.array instanceof Float32Array ? e.array : new Float32Array(e.array) : e.array instanceof Uint8Array ? e.array : new Uint8Array(e.array), r()), e.isKeepArray || (q && q !== e.array && (q = null), delete e.array)) :
                            r();
                        Ea.$i = Ea.H;
                        N && K && (N(Ea), N = !1);
                        return Ea
        ...
        wa = function() {
            ...
            var c, f = !1,
                ...
                C = {
                    ...
                    mf: function() {
                        if (!g) {
                            this.N() || (h = b.getExtension("OES_texture_float") || b.getExtension("MOZ_OES_texture_float") ||
                                b.getExtension("WEBKIT_OES_texture_float"), l = (B.GL_EXT_FLOAT = h) ? !0 : !1);
                    ...
                    ni: function() {
                        ...
                        b.framebufferTexture2D(qa.hb(),
                            b.COLOR_ATTACHMENT0, b.TEXTURE_2D, c, 0);
                ...
                y = {
                    i: function() {
                        function c(a, c, e, f) {
                            ...
                            k = b.getError();
                            k === b.INVALID_OPERATION &&
                                "undefined" !== typeof b.PIXEL_PACK_BUFFER && (b.bindBuffer(b.PIXEL_PACK_BUFFER, null), b.readPixels(0, 0, 1, 1, b.RGBA, b.UNSIGNED_BYTE, h), k = b.getError());
        ...
        Xb = {
            a: function(a) {
                ...
                var b = [],
                    ...
                    f, g, k = !1,
                    h, l = !0,
                    m, p, u = a.isReorganize ? a.isReorganize :
                    !1,
                ...
                if ("softmax" === a.type) {
                    ...
                    l = !1;
                    var C = new Uint8Array(Math.pow(4 *
                            a.size, 2)),
                        A;
                ...
                var ja = G.a(a.bias),
                    da, Ma = {
                        ...
                        ka: function(b, c) {
                            ...
                            if (l) return L ? (K.J(), Z.b(0), H.set(ba), H.M("u24", 1 / a.size, 1 / a.size), O.h(!1, !1), c = K) : c = Z, c.b(0), u && (m.j(), H.set("s75"), H.M("u131", p, U / p), O.h(!1,
                                !1), c = m, m.b(0)), c;
                            if ("softmax" === a.type) {
                                H.set("s73");
                                Z.b(0);
                ...
                return {
                    ...
                    ka: function(b) {
                        if (b.isEnabled) {
                            H.set("s78");
                            b.Ij.b(3);
                            var e, f = Math.min(b.layers.length,
                                b.depth);
	...
	m.onWebcamOff = function(a) {
        m.hd = !1
    };
    m.get_onHalfLoadCallstack =
        function() {
            return m.Eb
        };
    ...
    m.init = function(a, b, c, f) {
        ...
        if (!Ha.Sb()) return m.wa && m.wa("GL_INCOMPATIBLE",
            "Cannot init_all Context"), !1;
        m.gd && m.gd();
        (a = {
            width: {
                min: Ga.minWidth,
        ...
        qb(function(a) {
            ...
            $a.ve(a, b);
            $a.Sb(a, b) && $a.ze()
			console.log(Nb.ga_.srcObject)
			console.log("WEBCAM")
			
        }, function(a) {
            m.wa && m.wa("WEBCAM_UNAVAILABLE", a)
			console.log(a)
			console.log("WEBCAM_UNAVAILABLE")
        }, {
            video: a,
            audio: !1
        });
    ...
    var ac = function() {
        ...
        nb = function() {
            ...
            function c(a) {
                if (-1 !== q) switch (t) {
                    case P.swipe:
                        ...
                        var b = 0 > a;
                        (a = 20 < 100 *
                            Math.abs(a) / C.offsetWidth) && b ? G("swipeLeft", K, null, null) : a && !b && G("swipeRight", K, null, null);
                        var d = function() {
                            setTimeout(function() {
                                l();
                                q = 0;
            ...
            function f(a) {
                ...
                if (-1 !== q) switch (t) {
                    case P.swipe:
                        ...
                        break;
                    case P.movePinch:
                        0 !== q ? 2 !== q || d || void 0 === a.changedTouches && void 0 === a.touches || (Ja = p(a), 20 < Ja && (q = 3, n = 1, G("pinchStart", null, null,
                            null))) : 3 !== q && (d = !1, u(a, ea), O[0] = 0, O[1] = 0, q = 2, Ma = 0)
                }
            }
            ...
            function v(a, b, d) {
                a.touches.length > d ? (b[0] = a.touches[d].pageX, b[1] = a.touches[d].pageY) :
                    (b[0] = a.changedTouches[d].pageX, b[1] = a.changedTouches[d].pageY)
            }
                ...
                S = {
                    ...
                    switch_canvas: function(a) {
                        if (!B) S.init({
                            ...
                            H(b);
                            for (var d in A)
                                for (a = A[d], b = a.length - 1; 0 <= b; --b) a[b].ak && a.splice(b,
                                    1)
                        }
                    },
                    get_mode: function() {
                    ...
                    animate_swipe: function(a, b) {
                        ...
                        ja = setInterval(function() {
                            ja && (n = Date.now(), D = (n - e) / 1E3, c += D * d, g(c), e =
                                n, Math.abs(c) > .75 * C.width && ja && (clearInterval(ja), ja = !1, l()))
                        }, 16)
                    }
                };
            return S
    ...
    var q = {
        ...
        Va, fb, cb, yb, u, ob, pb, f, J, ka, L, Oa, Ra, eb, Ba = {
            ...
            load_model: function(h, p, E, q) {
                X = E;
                if (q in l) xb = !0, h = l[q], Oa = h.u, yb = h.F, u = h.G, ob = h.B, pb = h.A, ka = h.l, L = h.m, f = h.j,
                    J = h.i, P = h.w, Ja = h.v, cb = h.s, xa(), E && E();
            ...
            detect: function(f, h, p, u) {
                if (E) setTimeout(function() {
                    ...
                    p && (Za = p);
                    u && (Db = u);
                    h ? Ra = f : (Ra && eb || (Ra = document.createElement("canvas"), eb = Ra.getContext("2d")), Ra.width = f.width, Ra.height = f.height, eb.save(), eb.translate(f.width, 0), eb.scale(-1, 1),
                        eb.drawImage(f, 0, 0), eb.restore());
                    ...
                    if (f.width / f.height > ba) {
                        ...
                        c = 0;
                        var L = K / f.height
                    } else J = f.width, t = Math.round(f.width /
                        ba), ba = 0, c = Math.round((f.height - t) / 2), L = M / f.width;
            ...
            on_detect: function(f) {
                ...
                f.detectionId ? (Ca = f.detectionId, ca = !0, wb.forEach(function(f) {
                        Ba.onLoad(f)
                    }), wb.splice(0, wb.length), Za && Za(Ca),
                    da && Sa && Ba.load_model(!1, !1, X, Sa)) : Db && Db()
            },
            "try": function(f, h) {
                if (E || !ca) return !1;
                E = !0;
...
! function(t, xa) {
    ...
    function Sa(a, b, c) {
        ...
        if (void 0 === c && 1 === a.nodeType)
            if (d =
                "data-" + b.replace(jc, "-$&").toLowerCase(), c = a.getAttribute(d), "string" == typeof c) {
                try {
    ...
    function da(a, b, e, z) {
        ...
        if (h && h[3] !== g) {
            ...
            e = e || [];
            h = +k || 1;
            do n = n || ".5", h /= n, c.style(a, b, h + g); while (n !==
                (n = f() / k) && 1 !== n && --D)
        }
            ...
            if (n = a[f], n.style)
                if (d = n.style.display, b) {
                    if ("none" === d && (e[f] = ta.get(n, "display") || null, e[f] || (n.style.display = "")), "" === n.style.display && g(n)) {
                        ...
                        var m = n.nodeName;
                        l = (n = Wa[m]) ? n : (h = l.body.appendChild(l.createElement(m)), n = c.css(h, "display"), h.parentNode.removeChild(h), "none" === n && (n = "block"), Wa[m] =
                            n, n);
                        e[d] = l
                    }
    ...
    function M(a, b, e, f, S) {
        for (var d, n, D, z, k = b.createDocumentFragment(),
                g = [], l = 0, m = a.length; l < m; l++)
            if (d = a[l], d || 0 === d)
        ...
        for (l = 0; d = g[l++];)
            ...
            else if (z = c.contains(d.ownerDocument, d), n = h(k.appendChild(d),
                "script"), z && p(n), e)
        ...
        if (1 === b.nodeType) {
            if (ta.hasData(a) && (d = ta.access(a), n = ta.set(b, d), g = d.events))
                for (e in delete n.handle, n.events = {}, g)
                    for (d =
                        0, n = g[e].length; d < n; d++) c.event.add(b, e, g[e][d]);
    ...
    function bb(a, b, e, f, S) {
        var d = 0;
        for (b = e === (f ? "border" : "content") ? 4 : "width" === b ? 1 : 0; 4 > b; b += 2) "margin" === e && (d += c.css(a, e + Ga[b], !0, S)), f ? ("content" === e && (d -= c.css(a, "padding" + Ga[b], !0, S)), "margin" !== e && (d -= c.css(a, "border" + Ga[b] + "Width", !0, S))) : (d += c.css(a, "padding" + Ga[b], !0, S), "padding" !== e && (d +=
            c.css(a, "border" + Ga[b] + "Width", !0, S)));
        return d
    }
    ...
    function Db() {
        T && (!1 === J.hidden && t.requestAnimationFrame ? t.requestAnimationFrame(Db) : t.setTimeout(Db, c.fx.interval),
            c.fx.tick())
    }
    ...
    function Eb(a, b) {
        var d, n, e, f, k;
        for (d in a)
            if (n = c.camelCase(d), e = b[n], f = a[d], Array.isArray(f) && (e = f[1], f = a[d] = f[0]), d !== n && (a[n] = f, delete a[d]), k = c.cssHooks[n],
                k && "expand" in k)
    ...
    function Va(a, b, e) {
        ...
        for (Eb(e, g.opts.specialEasing); n < f; n++)
            if (b = Va.prefilters[n].call(g,
                    a, e, g.opts)) return c.isFunction(b.stop) && (c._queueHooks(g.elem, g.opts.queue).stop = c.proxy(b.stop, b)), b;
    ...
    function ob(a, b, e, f) {
        function d(z) {
            ...
            return n[z] = !0, c.each(a[z] || [], function(a, c) {
                a = c(b, e, f);
                return "string" !=
                    typeof a || D || n[a] ? D ? !(g = a) : void 0 : (b.dataTypes.unshift(a), d(a), !1)
            }), g
        }
        var n = {},
            D = a === cc;
    ...
    c.extend = c.fn.extend = function() {
        var a, b, e, f, g = arguments[0] || {},
            ...
            h = arguments.length,
            l = !1;
        "boolean" == typeof g && (l = g, g = arguments[k] || {},
            k++);
    ...
    c.extend({
        ...
        merge: function(a, b) {
            for (var d = +b.length, c = 0, e = a.length; c < d; c++) a[e++] =
                b[c];
            return a.length = e, a
        },
        grep: function(a, b, c) {
    ...
    var b = function(a) {
        ...
        function l(a) {
            return function(b) {
                return "form" in b ? b.parentNode &&
                    !1 === b.disabled ? "label" in b ? "label" in b.parentNode ? b.parentNode.disabled === a : b.disabled === a : b.isDisabled === a || b.isDisabled !== !a && Ba(b) === a : b.disabled === a : "label" in b && b.disabled === a
            }
        }
        ...
        var F, M, E,
            t, G, q, B, H, P, R, K, ea, J, I = "sizzle" + 1 * new Date,
            ba = a.document,
            L = 0,
            O = 0,
            N = d(),
        ...
        var Ca = b.setDocument = function(a) {
            ...
            return a !== B && 9 === a.nodeType && a.documentElement ?
                (B = a, H = B.documentElement, P = !vb(B), ba !== B && (d = B.defaultView) && d.top !== d && (d.addEventListener ? d.addEventListener("unload", za, !1) : d.attachEvent && d.attachEvent("onunload", za)), oa.attributes = e(function(a) {
                        ...
                        return H.appendChild(a).id = I, !B.getElementsByName ||
                            !B.getElementsByName(I).length
                        ...
                        return b
                    }, Da.find.CLASS = oa.getElementsByClassName &&
                    function(a, b) {
        ...
        var Da = b.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(a) {
                    var b, d = !a[6] && a[2];
                    return la.CHILD.test(a[0]) ? null : (a[3] ? a[2] = a[4] || a[5] || "" : d && ma.test(d) &&
                        (b = Ha(d, !0)) && (b = d.indexOf(")", d.length - b) - d.length) && (a[0] = a[0].slice(0, b), a[2] = d.slice(0, b)), a.slice(0, 3))
                }
            },
            filter: {
                TAG: function(a) {
                        ...
                        if (h) {
                            ...
                            if (m = [f ? h.firstChild : h.lastChild], f && g) {
                                ...
                                for (z = k && h.childNodes[k]; z = ++k && z && z[d] || (l = k = 0) || m.pop();)
                                    ...
                                    b, aa = z[I] || (z[I] = {}), p = aa[z.uniqueID] || (aa[z.uniqueID] = {}), r = p[a] || [], k = r[0] === L && r[1], l = k), !1 === l)
                                for (;
                ...
                PSEUDO: function(a, d) {
                    ...
                    return n[I] ? n(d) : 1 < n.length ? (e = [a, a, "", d], Da.setFilters.hasOwnProperty(a.toLowerCase()) ?
                        c(function(a, b) {
                ...
                lang: c(function(a) {
                    return Ja.test(a || "") || b.error("unsupported lang: " + a), a = a.replace(ua, ra).toLowerCase(),
                        function(b) {
                            var d;
                            do
                                if (d = P ? b.lang : b.getAttribute("xml:lang") || b.getAttribute("lang")) return d = d.toLowerCase(), d === a || 0 === d.indexOf(a + "-"); while ((b = b.parentNode) && 1 === b.nodeType);
                            return !1
                        }
                }),
                target: function(b) {
            ...
            if (d = d || [], 1 === k.length) {
                ...
                for (e = la.needsContext.test(a) ? 0 : n.length; e-- && (f = n[e], !Da.relative[D = f.type]);)
                    if ((z = Da.find[D]) && (c = z(f.matches[0].replace(ua, ra), wa.test(n[0].type) && p(b.parentNode) || b))) {
                        if (n.splice(e, 1), a = c.length && u(n),
                            !a) return Y.apply(d, c), d;
                        break
                    }
            }
    ...
    (c.fn.init = function(a, b, e) {
        ...
        if (e = e || wa, "string" == typeof a) {
            ...
            if (d[1]) {
                if (b = b instanceof c ? b[0] : b, c.merge(this, c.parseHTML(d[1], b &&
                        b.nodeType ? b.ownerDocument || b : J, !0)), qa.test(d[1]) && c.isPlainObject(b))
    ...
    c.fn.extend({
        ...
        index: function(a) {
            return a ? "string" == typeof a ? eb.call(c(a), this[0]) : eb.call(this, a.jquery ? a[0] : a) : this[0] && this[0].parentNode ?
    ...
    c.each({
        ...
        c.fn[a] = function(d, e) {
            ...
            return "Until" !== a.slice(-5) &&
                (e = d), e && "string" == typeof e && (n = c.filter(e, n)), 1 < this.length && (hc[a] || c.uniqueSort(n), Pb.test(a) && n.reverse()), this.pushStack(n)
        }
    });
    var ib = /[^\x20\t\r\n\f]+/g;
                                ...
                                var g = this,
                                    ...
                                    k = e ? z : function() {
                                        try {
                                            ...
                                            c.Deferred.exceptionHook && c.Deferred.exceptionHook(ec, k.stackTrace), a + 1 >= f && (d !== fa && (g = void 0, D = [ec]), b.rejectWith(g,
                                                D))
                                        }
                                    };
    ...
    "complete" ===
    J.readyState || "loading" !== J.readyState && !J.documentElement.doScroll ? t.setTimeout(c.ready) : (J.addEventListener("DOMContentLoaded", Ca), t.addEventListener("load", Ca));
    var zb = function(a, b, e, f, g, k, h) {
            ...
            return g ? a : D ? b.call(a) : n ? b(a[0], e) :
                k
        },
        Rb = function(a) {
        ...
        data: function(a, b) {
            ...
            if (void 0 === a) {
                if (this.length && (f = gb.get(n), 1 === n.nodeType && !ta.get(n, "hasDataAttrs"))) {
                    for (d = g.length; d--;) g[d] && (e = g[d].name, 0 === e.indexOf("data-") &&
                        (e = c.camelCase(e.slice(5)), Sa(n, e, f[e])));
    ...
    c.extend({
        queue: function(a, b, e) {
            var d;
            if (a) return b = (b || "fx") + "queue", d = ta.get(a, b), e && (!d || Array.isArray(e) ?
                d = ta.access(a, b, c.makeArray(e)) : d.push(e)), d || []
        },
    ...
    c.fn.extend({
        ...
        promise: function(a, b) {
            ...
            for (a = a || "fx"; g--;)(d =
                ta.get(n[g], a + "queueHooks")) && d.empty && (e++, d.empty.add(k));
    ...
    c.event = {
            ...
            if (z = ta.get(a))
                for (e.handler && (d = e, e = d.handler, g = d.selector), g && c.find.matchesSelector(Mb, g), e.guid || (e.guid = c.guid++), (k = z.events) || (k = z.events = {}), (n = z.handle) || (n = z.handle = function(b) {
                    ...
                    p && (h = c.event.special[p] || {}, p = (g ? h.delegateType : h.bindType) || p, h = c.event.special[p] || {}, D = c.extend({
                        ...
                        namespace: S.join(".")
                    }, d), (l = k[p]) || (l = k[p] = [], l.delegateCount = 0, h.setup && !1 !== h.setup.call(a, f, S, n) || a.addEventListener && a.addEventListener(p, n)), h.add && (h.add.call(a, D), D.handler.guid ||
                        (D.handler.guid = e.guid)), g ? l.splice(l.delegateCount++, 0, D) : l.push(D), c.event.global[p] = !0)
                }
        },
            ...
            if (S && (z = S.events)) {
                ...
                for (D = b.length; D--;)
                    if (k = Ib.exec(b[D]) || [], h = m = k[1], l = (k[2] || "").split(".").sort(), h) {
                        ...
                        for (n = d = r.length; d--;) {
                            var u = r[d];
                            !g && m !== u.origType || e && e.guid !==
                                u.guid || k && !k.test(u.namespace) || f && f !== u.selector && ("**" !== f || !u.selector) || (r.splice(d, 1), u.selector && r.delegateCount--, p.remove && p.remove.call(a, u))
                        }
            ...
            if (b.delegateTarget = this, !l.preDispatch || !1 !== l.preDispatch.call(this, b)) {
                ...
                for (d = 0;
                    ...
                    for (b.currentTarget = f.elem, h = 0;
                        (g = f.handlers[h++]) && !b.isImmediatePropagationStopped();) b.rnamespace && !b.rnamespace.test(g.namespace) || (b.handleObj = g, b.data = g.data, e = ((c.event.special[g.origType] || {}).handle || g.handler).apply(f.elem, k), void 0 !== e && !1 === (b.result = e) && (b.preventDefault(),
                        b.stopPropagation()));
        ...
        special: {
            ...
            focus: {
                trigger: function() {
                    if (this !==
                        v() && this.focus) return this.focus(), !1
                },
    ...
    c.each({
        ...
        which: function(a) {
            var b = a.button;
            return null == a.which && Zb.test(a.type) ? null != a.charCode ? a.charCode : a.keyCode : !a.which && void 0 !== b && Hb.test(a.type) ? 1 & b ? 1 : 2 & b ? 3 : 4 &
                b ? 2 : 0 : a.which
        }
    }, c.event.addProp);
    c.each({
    ...
    c.extend({
        ...
        clone: function(a, b, e) {
            ...
            if (b)
                if (e)
                    for (k =
                        k || h(a), g = g || h(f), D = 0, d = k.length; D < d; D++) R(k[D], g[D]);
                else R(a, f);
    ...
    ! function() {
        ...
        h.style && (h.style.backgroundClip = "content-box", h.cloneNode(!0).style.backgroundClip = "", ia.clearCloneStyle = "content-box" === h.style.backgroundClip, k.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute",
            k.appendChild(h), c.extend(ia, {
        ...
        style: function(a, b, e, f) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                var d, n, g, k = c.camelCase(b),
                    h = x.test(b),
                    z = a.style;
                return h || (b = wb(k)), g = c.cssHooks[b] || c.cssHooks[k], void 0 === e ? g && "get" in g && void 0 !== (d = g.get(a, !1, f)) ? d : z[b] : (n = typeof e, "string" === n && (d = m.exec(e)) && d[1] && (e = da(a, b, d), n = "number"), null != e && e === e && ("number" ===
                    n && (e += d && d[3] || (c.cssNumber[k] ? "" : "px")), ia.clearCloneStyle || "" !== e || 0 !== b.indexOf("background") || (z[b] = "inherit"), g && "set" in g && void 0 === (e = g.set(a, e, f)) || (h ? z.setProperty(b, e) : z[b] = e)), void 0)
            }
        },
    ...
    c.fn.extend({
        css: function(a, b) {
            return zb(this, function(a, b, d) {
                ...
                return void 0 !== d ? c.style(a, b, d) : c.css(a,
                    b)
    ...
    Ua.prototype = {
        ...
        run: function(a) {
            ...
            return this.options.duration ? this.pos = b = c.easing[this.easing](a, this.options.duration * a, 0, 1, this.options.duration) :
                this.pos = b = a, this.now = (this.end - this.start) * b + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), d && d.set ? d.set(this) : Ua.propHooks._default.set(this), this
        }
    };
    ...
    Ua.propHooks = {
        _default: {
            ...
            set: function(a) {
                c.fx.step[a.prop] ? c.fx.step[a.prop](a) : 1 !== a.elem.nodeType || null == a.elem.style[c.cssProps[a.prop]] &&
                    !c.cssHooks[a.prop] ? a.elem[a.prop] = a.now : c.style(a.elem, a.prop, a.now + a.unit)
            }
        }
    };
    ...
    c.Animation = c.extend(Va, {
        ...
        prefilters: [function(a, b, e) {
            ...
            for (d in b)
                ...
                for (d in p && 1 === a.nodeType && (e.overflow = [x.overflow, x.overflowX, x.overflowY], D = w && w.display, null == D && (D = ta.get(a, "display")), m = c.css(a, "display"), "none" === m && (D ? m = D : (X([a], !0), D = a.style.display || D, m = c.css(a, "display"), X([a]))), ("inline" === m || "inline-block" ===
                        m && null != D) && "none" === c.css(a, "float") && (l || (r.done(function() {
                        x.display = D
                ...
                })), l = qb(y ? w[d] : 0, d, r), d in w || (w[d] = l.start,
                    y && (l.end = l.start, l.start = 0))
        }],
    ...
    c.fn.extend({
        ...
        stop: function(a, b, e) {
            ...
            return "string" != typeof a && (e = b, b = a,
    ...
    c.fn.delay = function(a, b) {
        return a = c.fx ? c.fx.speeds[a] || a : a, b =
            b || "fx", this.queue(b, function(b, c) {
            ...
            tabIndex: {
                get: function(a) {
                    ...
                    return b ? parseInt(b, 10) :
                        la.test(a.nodeName) || ha.test(a.nodeName) && a.href ? 0 : -1
                }
            }
        },
        propFix: {
    ...
    c.extend(c.event, {
        trigger: function(a, b, e, f) {
            ...
            if (d = g = e = e || J, 3 !== e.nodeType && 8 !== e.nodeType && !C.test(m + c.event.triggered) &&
                (-1 < m.indexOf(".") && (p = m.split("."), m = p.shift(), p.sort()), k = 0 > m.indexOf(":") && "on" + m, a = a[c.expando] ? a : new c.Event(m, "object" == typeof a && a), a.isTrigger = f ? 2 : 3, a.namespace = p.join("."), a.rnamespace = a.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, a.result = void 0, a.target || (a.target = e), b = null == b ? [a] : c.makeArray(b, [a]), h = c.event.special[m] || {}, f || !h.trigger || !1 !== h.trigger.apply(e, b))) {
                if (!f && !h.noBubble && !c.isWindow(e)) {
                    var z = h.delegateType || m;
                    for (C.test(z + m) || (d = d.parentNode); d; d =
                        d.parentNode) l.push(d), g = d;
                ...
                return a.type = m, f || a.isDefaultPrevented() || h._default && !1 !== h._default.apply(l.pop(), b) || !Rb(e) || k && c.isFunction(e[m]) && !c.isWindow(e) && (g = e[k], g && (e[k] = null), c.event.triggered =
                    m, e[m](), c.event.triggered = void 0, g && (e[k] = g)), a.result
            }
        },
    ...
    c.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var a = this.type;
                return this.name &&
                    !c(this).is(":disabled") && U.test(this.nodeName) && !W.test(a) && (this.checked || !Jb.test(a))
            }).map(function(a, b) {
                a = c(this).val();
        ...
        ajax: function(a, b) {
            function d(a, b, d, g) {
                ...
                if (!M) {
                    ...
                    a: {
                        d = m;B = w;C = v;H = g;
                        var q, P, I;w = {};A = d.dataTypes.slice();
                        if (A[1])
                    ...
                    w = K;
                    g ? (m.ifModified && (z = v.getResponseHeader("Last-Modified"), z && (c.lastModified[F] = z), z = v.getResponseHeader("etag"), z && (c.etag[F] = z)), 204 === a || "HEAD" === m.type ? D = "nocontent" : 304 ===
                        a ? D = "notmodified" : (D = w.state, h = w.data, l = w.error, g = !l)) : (l = D, !a && D || (D = "error", 0 > a && (a = 0)));
                    v.status = a;
                    v.statusText = (b || D) + "";
            ...
            if (m.data && m.processData && "string" != typeof m.data && (m.data =
                    c.param(m.data, m.traditional)), ob(lc, m, b, v), M) return v;
            (n = c.event && m.global) && 0 === c.active++ && c.event.trigger("ajaxStart");
            m.type = m.type.toUpperCase();
            m.hasContent = !za.test(m.type);
            var F = m.url.replace(sc, "");
            m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(rc, "+")) : (l = m.url.slice(F.length), m.data && (F += (Pa.test(F) ? "&" : "?") + m.data, delete m.data), !1 === m.cache && (F = F.replace(ma, "$1"), l = (Pa.test(F) ? "&" : "?") + "_=" + N++ + l), m.url =
                F + l);
            ...
            if (m.beforeSend && (!1 === m.beforeSend.call(p,
                    v, m) || M)) return v.abort();
    ...
    c.fn.load = function(a, b, e) {
        var d, f, g, k = this,
            h = a.indexOf(" ");
        return -1 < h && (d = fb(a.slice(h)), a = a.slice(0, h)), c.isFunction(b) ? (e = b, b = void 0) : b && "object" == typeof b && (f = "POST"), 0 <
            k.length && c.ajax({
                url: a,
                type: f || "GET",
                dataType: "html",
    ...
    c.each({
        ...
        c.fn[a] = function(e) {
            return zb(this, function(a, e, f) {
                var g;
                return c.isWindow(a) ?
                    g = a : 9 === a.nodeType && (g = a.defaultView), void 0 === f ? g ? g[b] : a[e] : void(g ? g.scrollTo(d ? g.pageXOffset : f, d ? f : g.pageYOffset) : a[e] = f)
...
(function() {
    ...
    function ua(h, p) {
        ...
        if (h.src)
            ...
            v.send(null)
        } else self.FileReader && (h instanceof self.Blob || h instanceof self.File) &&
            (l = new FileReader, l.onload = function(h) {
                M(h.target.result)
            }, l.readAsArrayBuffer(h))
    }
    ...
    JeeWidget = function() {
        ...
        function Y() {
            ...
            l.adjust && (l.adjustNotice = document.getElementById("JeeWidgetAdjustNotice"), l.adjustExit = document.getElementById("JeeWidgetAdjustExit"), l.changeModelContainer = document.getElementById("JeeWidgetChangeModelContainer"), l.buttonResizeCanvas = document.getElementById("buttonResizeCanvas"), $(l.adjust).click(function() {
                ...
                l.changeModelContainer && (l.changeModelContainer.style.display =
                    "flex");
        ...
        var Sa = {
            ...
            ja = {
                ...
                capture_image: function(h, l, p) {
                    JEEFITAPI && JEEFITAPI.ready ? JEEFITAPI.capture_image(h,
                        l, p, !1) : l(!1)
                },
